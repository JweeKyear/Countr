...
namespace Countr.Core.Tests.ViewModels
{
    ...
    public class CountersViewModelTests
    {
        ...
        public async Task LoadCounters_CreatesCounters()
        {
            ...
            countersService.Setup(c => c.GetAllCounters()).ReturnsAsync(counters);
        ...
        //    // Assert
        //    navigationService.Verify(n => n.Navigate(typeof(CounterViewModel), It.IsAny<Counter>(), null));
        //}
    }
}
